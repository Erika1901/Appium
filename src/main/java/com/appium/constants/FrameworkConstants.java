...
public class FrameworkConstants {
	...
	public static final String TEST_DATA_JSON_FILE2 = "data/signInUser.json";
	...
	public static final String TEST_DATA_JSON_USER = "user";

	public static final String TEST_DATA_JSON_USERNAME = "username";
	public static final String TEST_DATA_JSON_PASSWORD = "password";

	public static final String TEST_DATA_JSON_PWD = "pwd";
	public static final String TEST_DATA_JSON_EMAIL = "email";
	public static final String TEST_DATA_JSON_FIRSTNAME = "firstname";
	public static final String TEST_DATA_JSON_LASTNAME = "lastname";
